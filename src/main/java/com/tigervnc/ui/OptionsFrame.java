...
public class OptionsFrame extends Frame implements WindowListener, ActionListener, ItemListener {
  ...
  public void setEncodings() {
    ...
    if (choices[encodingIndex].getSelectedItem().equals("RRE")) {
      preferredEncoding = Encodings.EncodingRRE;
    } else if (choices[encodingIndex].getSelectedItem().equals("CoRRE")) {
      preferredEncoding = Encodings.EncodingCoRRE;
      ...
      preferredEncoding = Encodings.EncodingZRLE;
    } else if (choices[encodingIndex].getSelectedItem().equals("Zlib")) {
      preferredEncoding = Encodings.EncodingZlib;
